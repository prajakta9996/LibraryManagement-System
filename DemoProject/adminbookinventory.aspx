<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminbookinventory.aspx.cs" Inherits="DemoProject.adminbookinventory" %>
         ...
         <div class="col-md-7">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                      <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:eliabraryDBConnectionString %>" SelectCommand="SELECT * FROM book_master_tbl"></asp:SqlDataSource>
                     <div class="col">
                                               ...
                                               <div class="col-lg-10">
                                                   ...
                                                   <div class="row">
                                                       <div class="col-lg-12">
                                                           ...
                                                           Cost -
                                                           <asp:Label ID="Label8" runat="server" Font-Bold="True" Text='<%# Eval("book_cost") %>'></asp:Label>
                                                           &nbsp;Actual Stock -
